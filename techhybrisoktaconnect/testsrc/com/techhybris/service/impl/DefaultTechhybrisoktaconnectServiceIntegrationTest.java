...
import com.techhybris.service.impl.DefaultTechhybrisoktaconnectService;
 ...
 */
@IntegrationTest
public class DefaultTechhybrisoktaconnectServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "techhybrisoktaconnectPlatformLogo";

		// when
		final String logoUrl = techhybrisoktaconnectService.getHybrisLogoUrl(logoCode);
