...
import com.techhybris.constants.TechhybrisoktassoaddonConstants;



/**
 * This is the extension manager of the Techhybrisoktassoaddon extension.
 */
public class TechhybrisoktassoaddonManager extends GeneratedTechhybrisoktassoaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TechhybrisoktassoaddonManager.class.getName());
	 ...
	 */
	public static TechhybrisoktassoaddonManager getInstance()
	{
		return (TechhybrisoktassoaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TechhybrisoktassoaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TechhybrisoktassoaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TechhybrisoktassoaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TechhybrisoktassoaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TechhybrisoktassoaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
